        ...
        <div class="row">
            <div class="col-lg-7 px-0">
                ...
                <div class="position-relative overflow-hidden" style="height: 500px;">
                        <a href="<?php the_permalink() ?>" class="img-fluid h-100" style="object-fit: cover;">
                                        <?php the_post_thumbnail('biznews-slider-center') ?>
                                    </a>
                        <div class="overlay">
                            <div class="mb-2">
            ...
            <div class="col-lg-5 px-0">
                ...
                ?>
                    <div class="col-md-6 px-0">
                        ...
                        <a href="<?php the_permalink() ?>" class="img-fluid h-100" style="object-fit: cover;">
                                        <?php the_post_thumbnail('biznews-medium') ?>
                                    </a>
                            <div class="overlay">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                        href="">Business</a>
                                    <a class="text-white" href=""><small><?php echo get_the_date(); ?></small></a>
                                </div>
            ...
            <div class="row align-items-center bg-dark">
                <div class="col-12">
                    ...
                    while($blog_posts->have_posts()) {
                        $blog_posts->the_post();
                ?>
                            <div class="text-truncate"><a class="text-white text-uppercase font-weight-semi-bold" href="<?php the_permalink() ?>"><?php the_title() ?></a></div>
                            <?php }
                ?>
                <?php wp_reset_postdata() ?>
                        </div>
    ...
    <div class="container-fluid pt-5 mb-3">
        <div class="container">
            ...
            $blog_args = array(
                ...
                <a href="<?php the_permalink() ?>" class="img-fluid h-100" style="object-fit: cover;">
                                        <?php the_post_thumbnail('biznews-medium-square') ?>
                                    </a>
                    <div class="overlay">
                        <div class="mb-2">
                            <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
